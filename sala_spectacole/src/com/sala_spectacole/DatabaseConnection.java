package com.sala_spectacole.connection;
...
public class DatabaseConnection {
    ...
    private final String url = "jdbc:mysql://localhost:3306/organizare?createDatabaseIfNotExist=true";

    private final String username = "root";

    private final String password = "luana";
